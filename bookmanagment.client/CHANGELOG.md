...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest bookmanagment.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`bookmanagment.client.esproj`).
